                    ...
                    <Col sm={8}>
                        <Card>
                            ...
                            <Row style={{ margin: "20px" }}>
                                <Col>
                                    <Container>
                                        <h1>Cone Pulveriser:</h1>
                                        Suitable for Grinding Turmeric, Besan,
                                        Tamarind Seeds, Dry Ginger, Saw Dust,
                                        Agarbatti Material, Roots, Herbal Leafs, Black
                                        Grams (Urud Dal), Bengal Gram (Chana Dal),
                                        Red Oxide, Gypsum, China Clay, Shikakai,
                                        Lime Stone, Coconut Shell, Soap Stone etc.<br /><br />
                                        We Can Grind all fine powders 60, 80, 100
                                        upto 200 Mesh by adjusting Whizzer. <br /><br />
