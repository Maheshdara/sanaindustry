                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a to="#" onClick={() => toggleMenu(6)}>
                                                ...
                                                /Sugar Grinding Pulveriser                                                <FontAwesomeIcon icon={subMenuOpen === 6 ? faMinus : faPlus} />
                                            </a>
                            ...
                            <Row style={{ margin: "20px" }}>
                                <Col sm={6}>
                                    <Container>
                                        ...
                                        ground sugar will be used for mixing in milk powders,
                                        ice creams etc.
                                        Hourly capacity 40 Kg to 700 Kg Per Hour<br /><br />
                                        Range of capacity : According to the customer
                                        requirement will be manufactured (from 10 HP to 50
                                        HP) – Cone Pulveriser, Screw Conveyor, Dust
                                        Collector, Rotary Valve<br /><br />
                                    </Container>
