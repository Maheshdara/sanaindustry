                            ...
                            <Row style={{ margin: "20px" }}>
                                <Col>
                                    <Container>
                                        ...
                                        Chillies, Coriander, Cumin, Black Pepper, Other
                                        Spices, Leafs, Roots, Sugar, Husk.<br /><br />
                                        We Can Grind 30 to 40 Mesh Powders by
                                        Changing Perforated Sheet (Sieves).<br /><br />
                                        Made in Mild Steel and Stainless Steel SS 304 and
                                        various capacities 5 HP to 80 HP.
                                    </Container>
