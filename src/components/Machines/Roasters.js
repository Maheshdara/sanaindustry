...
import "../componet.css";
import roaster from "./images/Roaster.JPG"
                            ...
                            <Row style={{ margin: "20px" }}>
                                <Col>
                                    <Container>
                                        ...
                                        system everything will be adjusted in the Control
                                        Panel (heat according to product).<br /><br />
                                        Ranges 100 kg to 500 kg per batch<br /><br />
                                        This roaster can be utilized as Blending and
                                        mixing the material it means works for duel
                                        purpose. If we can switch off the electric coils
                                        working only for mixing.
